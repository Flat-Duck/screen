...
class ExportOpenApiContract extends Command
{
    ...
    private function schemas(): array
    {
        return [
            ...
            'PostMedia' => ['type' => 'object', 'required' => ['id', 'position', 'url', 'original_url', 'thumbhash', 'width', 'height', 'status', 'alt_text', 'safety_status'], 'properties' => ['id' => ['type' => 'integer'], 'position' => ['type' => 'integer'], 'url' => ['type' => 'string'], 'original_url' => ['type' => 'string'], 'thumbhash' => ['type' => ['string', 'null'], 'description' => 'Base64 ThumbHash (~25 bytes decoded). Render as a blurred placeholder while the image loads; null on media that predates the field.'], 'width' => ['type' => ['integer', 'null']], 'height' => ['type' => ['integer', 'null']], 'status' => ['type' => 'string'], 'alt_text' => ['type' => ['string', 'null']], 'safety_status' => ['type' => 'string']]],
