...
| `POST /v1/auth/social/google` | Device | Sign in with a Google OAuth access token | `access_token`, `device_name` (optional) | Same as login; 201 + `is_new_account: true` if this created a new account | ☑ | |
