...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        collect([
            ['name' => 'Alice Nakamura', 'username' => 'alice', 'email' => 'alice@example.com'],
            ['name' => 'Bob Sanderson', 'username' => 'bob', 'email' => 'bob@example.com'],
            ['name' => 'Carol Vasquez', 'username' => 'carol', 'email' => 'carol@example.com'],
